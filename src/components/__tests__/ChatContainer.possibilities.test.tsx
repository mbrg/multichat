...
describe('ChatContainer - Possibilities', () => {
  ...
  it('handles multiple conversation turns correctly', () => {
    ...
    const selectedPossibility = createMockPossibility('p1', 'Second response option A')
    const possibilities = [
      selectedPossibility,
  ...
  it('handles case when no matching user message is found', () => {
    ...
    const possibilities = [
      createMockPossibility('p1', 'Orphaned response')
    ]
  ...
  it('handles complex conversation with multiple possibilities', () => {
    const messages: Message[] = [
      { id: 'u1', role: 'user', content: 'Tell me about AI', timestamp: new Date() },
      { 
        id: 'a1', 
        role: 'assistant', 
        ...
        timestamp: new Date(),
        possibilities: [
          { id: 'p1', role: 'assistant', content: 'AI is revolutionary', timestamp: new Date(), isPossibility: true },
          { id: 'p2', role: 'assistant', content: 'AI is transformative', timestamp: new Date(), isPossibility: true }
        ]
      },
      { id: 'u2', role: 'user', content: 'What about machine learning?', timestamp: new Date() },
      { 
        id: 'a2', 
        role: 'assistant', 
        ...
        timestamp: new Date(),
        possibilities: [
          { id: 'p3', role: 'assistant', content: 'ML uses algorithms to learn', timestamp: new Date(), isPossibility: true },
          { id: 'p4', role: 'assistant', content: 'ML enables pattern recognition', timestamp: new Date(), isPossibility: true }
        ]
      }
    ]
