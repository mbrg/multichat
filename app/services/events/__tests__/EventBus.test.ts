...
describe('EventBus', () => {
  ...
  describe('event subscription', () => {
    it('should subscribe to specific event type', () => {
      ...
      const subscription = testEventBus.subscribe('ai:generation:started', handler)
    ...
    it('should remove event type when no subscribers remain', () => {
      ...
      const subscription = testEventBus.subscribe('ai:generation:started', handler)
      expect(testEventBus.getActiveEventTypes()).toContain('ai:generation:started')
      
      subscription.unsubscribe()
      expect(testEventBus.getActiveEventTypes()).not.toContain('ai:generation:started')
    })
  })
